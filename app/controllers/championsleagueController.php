...
class ChampionsLeagueController {
    ...
    public function load() {
        ...
        $pageTitle = "Lose1Max | Champions League";
        ...
        $classement = $this->db->request("SELECT E.url_logo, C.position, E.nom_equipe, C.points, C.joues, C.victoires, C.nuls, C.defaites, C.buts_pour, C.buts_contre, C.difference_buts
                                        FROM `classement_champions_league` AS C, `equipes` AS E
        ...
        $css_list = [
                ...
                $import["champions_league"], $import["header"], 
        ...
        $js_list = [
            $import["sponsor"], $import["champions_league"],
        ];
        ...
        require "app/views/championsleague.phtml";
